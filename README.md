...
This is a boilerplate to build a full stack web application using MERN (Mongo, Express, React/Redux, Node) stack. It is also configured with webpack-dev-server, eslint, prettier and babel.
...
git clone https://github.com/crsandeep/mern-boilerplate
